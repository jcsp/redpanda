...
class RedpandaService(Service):
    ...
    def __init__(self,
        ...
        # For upgrade tests only: write a redpanda.yaml that contains all
        # configuration, including cluster config properties, which is
        # compatible with redpanda 21.11.x
