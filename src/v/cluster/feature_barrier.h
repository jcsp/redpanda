...
public:
    feature_barrier_state(
      ...
      ss::gate& gate,
      rpc_fn fn)
      : feature_barrier_state_base(self, members, as, gate, fn) {}
...
protected:
    ...
    ss::future<> retry_sleep() override {
        ...
        // return ss::sleep_abortable(retry_period, _as.local());
        return ss::sleep_abortable<Clock>(retry_period, _as.local());
    };
};
